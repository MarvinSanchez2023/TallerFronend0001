...
const ListadoComponent = () => {
    ...
    const iniciarSesion = (opcion, id, nombre, edad) => {
        setId('');
        setNombre('Usuario');
        setEdad('Contrasena');
        setOperacion(opcion);
    ...
    return (
        ...
        <div className="App">
                ...
                <div className="row mt-3">
                    <div className="col-md-4 offset-md-4">
                        <div className="d-grid mx-auto">
                            ...
                            >
                                <i className="fa-solid fa-circle-plus"></i>iniciar Seccion
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div id="modalIniciarsesion" className="modal fade" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <label className="h5">login</label>
                        </div>
                        <div className="modal-body">
                            <input type="hidden" id="id"></input>
                            <div className="input-group mb-3">
                            ...
                            <div className="d-grid col-6 mx-auto">
                                <button onClick={() => openModal(1)} className="btn btn-primary">
                                    <i className="fa-solid fa-floppy-disk"></i>Iniciar Sesion
                                </button>
                            </div>
                        </div>
                    </div>
